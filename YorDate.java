...
public class YorDate {
    ...
    public static void main(String args[]) {
        ...
        date1 = new YorDate(8, 5, 2015);// creating an object with three parameters based on the constructor
        System.out.println("Today's date is " + date1.toString());

        //Using the appropriate methods set, set date1 to your birthdate
        date1.setDay(1);
        date1.setMonth(2);
        date1.setYear(1988);
        System.out.println("My birthday information");
        System.out.println("Day: " + date1.getDay());
        System.out.println("Month: " + date1.getMonth());
        System.out.println("Year: " + date1.getYear());

        //Using appropriate date1 method(s) display your birthday
        System.out.println("My birthday is on a " + date1.getDayOfWeek());
    }
     ...
     * @return true if dayTest-monthTest-yearTest represents a valid date
     * false otherwise
     */
     ...
     * @return the integer value representing difference between the dates
     */
