package practice;// Week3 Lab2 Exercise3
...
public class PushMe extends Application {
    ...
    // button to display length of text
        ...
        txtLengthButton.setOnAction(e -> txtLengthLabel.setText("The number of letters is: " + pushMeTextField.getText().length()));
        ...
        root.getChildren().addAll(pushMeTextField, pushMeButton, pushMeLabel, txtLengthButton, txtLengthLabel);
